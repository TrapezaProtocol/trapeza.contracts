...
contract TeamTrapezaToken is Divine {
  ...
  constructor() Divine( "teamTrapeza", "tFIDL", 18 ) {
    uint256 initialSupply_ = 330000000 * 1e18;
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 amount_ ) internal override {
    require( (_balances[to_] > 0 || isApprovedSeller[from_] == true), "Account not approved to transfer tFIDL." );
  }
